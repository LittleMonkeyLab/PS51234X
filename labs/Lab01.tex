...
\hypersetup{
  pdftitle={Lab01: Intro to lab work},
  colorlinks=true,
  linkcolor=blue,
  filecolor=Maroon,
  citecolor=Blue,
...
\title{\textbf{Lab01: Intro to lab work}}
\author{}
...
\fancyfoot[C]{\footnotesize\textcolor{gray}{Lab01: Intro to lab work}}
...
\begin{document}
    ...
    \begin{center}
    \vspace*{5cm}
    {\Huge\bfseries Lab01: Intro to lab work}\\
          \vfill
