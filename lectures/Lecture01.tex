...
\hypersetup{
  pdftitle={Lecture01: Psych Science},
  colorlinks=true,
  linkcolor=blue,
  filecolor=Maroon,
  citecolor=Blue,
...
\title{\textbf{Lecture01: Psych Science}}
\usepackage{etoolbox}
\makeatletter
...
\fancyfoot[L]{\footnotesize\textcolor{gray}{PS51234X}}
\fancyfoot[C]{\footnotesize\textcolor{gray}{Lecture01: Psych Science}}
...
\begin{document}
    ...
    \begin{center}
    \vspace*{5cm}
    {\Huge\bfseries Lecture01: Psych Science}\\
          \vfill
      {\large\bfseries PS51234X}
        \end{center}
...
\hypertarget{bullet-point-list}{%
\subsection{Bullet point list}\label{bullet-point-list}}
...
\hypertarget{incremental-list}{%
\subsection{Incremental list}\label{incremental-list}}
...
\item
  Built-in
  \href{https://quarto.org/docs/presentations/revealjs/themes.html\#using-themes}{Reveal
  theme}
\item
