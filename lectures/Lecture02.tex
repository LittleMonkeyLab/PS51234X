...
\hypersetup{
  pdftitle={Lecture02: Like it when I found it!},
...
\title{\textbf{Lecture02: Like it when I found it!}}
...
\fancyfoot[C]{\footnotesize\textcolor{gray}{Lecture02: Like it when I
found it!}}
...
\begin{document}
    ...
    \begin{center}
    \vspace*{5cm}
    {\Huge\bfseries Lecture02: Like it when I found it!}\\
          \vfill
...
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[borderline west={3pt}{0pt}{shadecolor}, breakable, enhanced, frame hidden, boxrule=0pt, interior hidden, sharp corners]}{\end{tcolorbox}}\fi
...
\section{Slide content}\label{slide-content}}
