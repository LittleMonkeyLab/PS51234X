...
```
If you prefer to view the demo in a standalone browser you can do that [here](http://ps52007dslides.littlemonkeylab.com/labs/Lab02/Lab02.html){target="_blank"}. Check out the [source code](https://github.com/quarto-dev/quarto-web/blob/main/docs/presentations/revealjs/demo/index.qmd) for them demo to see how the slides were created.
:::
